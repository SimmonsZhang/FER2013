...
def load_data(data_file):
    ...
    emotions = pd.get_dummies(data['emotion']).values  # pd.get_dummies()将labels转换为OneHot形式
...
if __name__ == '__main__':
    faces, emotions = load_data('./data/fer2013/fer2013.csv')
    print(faces.shape)
    plt.imshow(faces[0].reshape((48, 48)), cmap='gray')
    plt.show()
